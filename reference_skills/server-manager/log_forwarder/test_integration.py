...
Run on the managed SOC host:
    cd ${SOC_TESTING_DIR:-/opt/soc-testing}/log_forwarder
...
SOC_COMPOSE_DIR = os.environ.get("SOC_TESTING_DIR", "/opt/soc-testing")
WAZUH_COMPOSE_DIR = os.environ.get("WAZUH_COMPOSE_DIR", "/opt/soc-testing/wazuh_deploy")
...
def test_log_files_exist():
    ...
    zeek_dir = os.environ.get("ZEEK_LOG_DIR", "/opt/soc-testing/logs/zeek")
