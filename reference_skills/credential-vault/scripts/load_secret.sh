...
credential_vault_credman_candidates() {
    ...
    printf '%s\n' \
        "./reference_skills/credential-vault/scripts/credman.py" \
        "../credential-vault/scripts/credman.py" \
        "../../credential-vault/scripts/credman.py" \
        "$HOME/.agents/skills/credential-vault/scripts/credman.py" \
        "$HOME/.claude/skills/credential-vault/scripts/credman.py" \
        "$HOME/.agents/skills/server-manager/credman.py" \
        "$HOME/.claude/skills/server-manager/credman.py"
}
