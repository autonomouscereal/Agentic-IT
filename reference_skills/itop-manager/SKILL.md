...
allowed-tools: Bash("C:/Users/me/.Codex/skills/server-manager/ssh_client.py" "--ai" "--execute" "*"), Read, Edit, Write, Glob, Grep
---
...
```bash
"C:/Users/me/.Codex/skills/server-manager/ssh_client.py" --ai --execute "python3 /opt/agentic-it/SOC_TESTING/itop-deployment/scripts/itop_client.py check"
```
