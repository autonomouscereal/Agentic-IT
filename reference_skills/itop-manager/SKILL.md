...
| Operation | Command |
|-----------|---------|
| Check auth | `...ssh_client.py" --server ai --execute "python3 .../itop_client.py check"` |
| Get object | `...ssh_client.py" --server ai --execute "python3 .../itop_client.py get Incident 1 --fields 'id,title,status'"` |
| Query class | `...ssh_client.py" --server ai --execute "python3 .../itop_client.py get Organization 'SELECT Organization' --fields 'id,name'"` |
| Create | `...ssh_client.py" --server ai --execute "python3 .../itop_client.py create Incident '{\"org_id\":1,\"caller_id\":94,\"title\":\"X\",\"description\":\"Y\",\"impact\":3,\"urgency\":3}'"` |
| Update | `...ssh_client.py" --server ai --execute "python3 .../itop_client.py update Incident 1 '{\"title\":\"New title\"}'"` |
| Delete | `...ssh_client.py" --server ai --execute "python3 .../itop_client.py delete Incident 1"` |
| Stimulus | `...ssh_client.py" --server ai --execute "python3 .../itop_client.py stimulus Incident 1 ev_resolve --fields '{\"resolution_code\":\"assistance\",\"solution\":\"Resolved\"}'"` |
...
7. **Key extraction**: Prefer object `key`, then `fields.id`, then parse the object reference like `Incident::170`.
